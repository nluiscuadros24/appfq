...
def Display_title():
	title = Label(root,text="Convertidor Fredy",bd=5,bg="white",font=("Roboto",25,"bold"),relief=GROOVE)
...
def Display_speech():
	...
	bt = Button(root,text="empieza a hablar",bg='white',font=("Roboto",15,"bold"),command = speech_button)
	bt.place(x=90,y=399)
	arrow = Label(root,image=arrow_logo)
